<footer class="text-center lg:text-left bg-gray-100 text-gray-600">
	<div class="mx-6 py-10 text-center md:text-left">
		<div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
			...
			<div>
				...
				<p class="mb-4">
					<a href="/shop/mens" class="text-gray-600">Mens</a>
				</p>
				<p class="mb-4">
					<a href="/shop/womens" class="text-gray-600">Womens</a>
				</p>
				<p class="mb-4">
					<a href="/shop/asics" class="text-gray-600">Asics</a>
				</p>
				<p class="mb-4">
					<a href="/shop/new-balance" class="text-gray-600">New Balance</a>
				</p>
			</div>
			<div>
	...
	<div class="text-center p-6 bg-gray-200">
		<a href="https://github.com/SwiftMarket">© 2025, DataLayer Example</a>
	</div>
</footer>
