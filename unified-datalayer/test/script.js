...
document.getElementById('plp-view-valid').addEventListener('click', () => {
...
document.getElementById('plp-filter-valid').addEventListener('click', () => {
...
document.getElementById('plp-sort-valid').addEventListener('click', () => {
...
document.getElementById('pdp-view-valid').addEventListener('click', () => {
...
document.getElementById('pdp-size-valid').addEventListener('click', () => {
...
document.getElementById('pdp-color-valid').addEventListener('click', () => {
...
function updateDataLayerDisplay() {
    ...
    try {
        ...
        if (window.adobeDataLayer) {
            ...
            // Get recent events
            const recentEvents = window.adobeDataLayer.slice(
                Math.max(0, window.adobeDataLayer.length - 5),
